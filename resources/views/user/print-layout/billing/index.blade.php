...
@section('content')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-8">
            <h2>Billing Print Layout</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="/">Home</a>
                </li>
                <li class="active">
                    <strong>Billing Print Layout</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-4">
            <div class="title-action">
                <a href="{!! route('print-billing') !!}" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i> Print Invoice </a>
                <a href="{!! route('pdf-billing') !!}" target="_blank" class="btn btn-primary"><i class="fa fa-file-pdf-o"></i> PDF </a>
            </div>
        </div>
    </div>
